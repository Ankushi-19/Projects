...
pibtp=Button(btnrow1,text="+" ,font="segoe 23",relief=GROOVE,bd=0,command=btn_p,fg="white",bg="#333333").pack(side=LEFT,expand=TRUE,fill=BOTH)
...
conv_btn=Button(btnrow3,text="Rad" ,font="segoe 12 bold",relief=GROOVE,bd=0,command=conv,fg="white",bg="#333333").pack(side=LEFT,expand=TRUE,fill=BOTH)
